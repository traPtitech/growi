...
const ACTION_USER_LOGIN_WITH_TRAQ = 'USER_LOGIN_WITH_TRAQ';
...
const ACTION_ADMIN_AUTH_TRAQ_ENABLED = 'ADMIN_AUTH_TRAQ_ENABLED';
const ACTION_ADMIN_AUTH_TRAQ_DISABLED = 'ADMIN_AUTH_TRAQ_DISABLED';
const ACTION_ADMIN_AUTH_TRAQ_UPDATE = 'ADMIN_AUTH_TRAQ_UPDATE';
...
export const SupportedAction = {
  ...
  ACTION_ADMIN_AUTH_TRAQ_ENABLED,
  ACTION_ADMIN_AUTH_TRAQ_DISABLED,
  ACTION_ADMIN_AUTH_TRAQ_UPDATE,
